...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize tsParticles for preloader
    tsParticles.load("preloader-particles", {
    ...
    const assets = [
        ...
        'pic3.jpg',
        'pic4.jpg',
        'src/assets/certificates/abdsa.jpg',
        'src/assets/certificates/php.jpg',
        'src/assets/certificates/node.jpg',
        'src/assets/certificates/fully.jpg',
        'src/assets/certificates/nptel_page-0001.jpg',
        'KSR.pdf'
    ];
    let loadedAssets = 0;
    ...
    // Preload assets
    assets.forEach(src => {
        const asset = src.endsWith('.pdf') ? new XMLHttpRequest() : new Image();
        if (src.endsWith('.pdf')) {
            asset.open('GET', src, true);
            asset.responseType = 'blob';
            asset.onload = () => {
                loadedAssets++;
                updateProgress();
            };
    ...
    const updateProgress = () => {
        progress = (loadedAssets / assets.length) * 100;
